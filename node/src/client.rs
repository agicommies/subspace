...
use subspace_rpc::SubspaceRuntimeApi;
...
pub type Client = FullClient<node_subspace_runtime::RuntimeApi, TemplateRuntimeExecutor>;
...
impl NativeExecutionDispatch for TemplateRuntimeExecutor {
    ...
    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        node_subspace_runtime::api::dispatch(method, data)
    }

    fn native_version() -> NativeVersion {
        node_subspace_runtime::native_version()
    }
}
